...
namespace ct {
	...
	struct tmat4 {
		...
		CT_CONSTEXPR tmat4();
		CT_CONSTEXPR tmat4(const tmat4<T> & other);

		// Explicit constructors

		explicit CT_CONSTEXPR tmat4(T identity);
		...
		CT_CONSTEXPR void set(T m00,T m10,T m20,T m30,
		                   T m01,T m11,T m21,T m31,
		                   T m02,T m12,T m22,T m32,
		                   T m03,T m13,T m23,T m33);
		...
		CT_CONSTEXPR tmat4<T> inverse() const;
		...
		///
		////////////////////////////////////////////////////////////
		CT_CONSTEXPR T * operator()();

		////////////////////////////////////////////////////////////
		/// @brief Get pointer to matrix data
		///
		////////////////////////////////////////////////////////////
		CT_CONSTEXPR const T * operator()() const;
	...
	template <typename T>
	CT_CONSTEXPR tmat4<T> operator*(const tmat4<T> & mat, T scalar);
